...
global infoHudText := infoHud.AddText("c111827", "F8   Pause / Resume`nF9   Next section`nF10  Add 2 minutes`nF11  Remove 2 minutes`nCtrl+Plus/Minus  Scale UI")
...
ApplyScale() {
    ...
    infoHudText := infoHud.AddText("c111827", "F8   Pause / Resume`nF9   Next section`nF10  Add 2 minutes`nF11  Remove 2 minutes`nCtrl+Plus/Minus  Scale UI")
    tipVisible := false
